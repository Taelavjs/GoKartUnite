...
namespace GoKartUnite.Migrations
{
    ...
    [Migration("20250703145813_friendStatusNotificationTabl")]
    partial class friendStatusNotificationTabl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoKartUnite.Models.FriendStatusNotifications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FriendStatusNotifications");
                });
            ...
            modelBuilder.Entity("GoKartUnite.Models.FriendStatusNotifications", b =>
                {
                    b.HasOne("GoKartUnite.Models.Karter", "Friend")
                        .WithMany()
                    ...
                    b.HasOne("GoKartUnite.Models.Karter", "karter")
                        .WithMany("FriendStatusNotifications")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("GoKartUnite.Models.Karter", b =>
                {
                    ...
                    b.Navigation("FriendStatusNotifications");
